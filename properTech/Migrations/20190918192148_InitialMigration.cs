    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaintenanceRequest", x => x.MaintenanceTechId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MaintenanceRequest_1", x => x.RequestId);
                    table.ForeignKey(
                        name: "FK_MaintenanceRequest_1_Resident_residentId",
                        column: x => x.residentId,
                        principalTable: "Resident",
                        principalColumn: "ResidentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MaintenanceRequest_1_MaintenanceRequest_techMaintenanceTechId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRequest_1_residentId",
                table: "MaintenanceRequest_1",
                column: "residentId");

            migrationBuilder.CreateIndex(
                name: "IX_MaintenanceRequest_1_techMaintenanceTechId",
                table: "MaintenanceRequest_1",
