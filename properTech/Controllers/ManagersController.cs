...
namespace properTech.Controllers
{
    public class ManagersController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Manager.Include(m => m.property);
        ...
        public async Task<IActionResult> Create([Bind("Id,firstName,lastName,propertyId,residentId")] Manager manager)
        {
            ...
            ViewData["propertyId"] = new SelectList(_context.Set<Property>(), "Id", "Id", manager.propertyId);
            return View(manager);
        }
