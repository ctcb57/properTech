...
function getUserInput() {
    ...
    if (userInput.includes("hello") || userInput.includes("hi")) {
        ...
        document.getElementById("chadResponse").innerHTML = "<span>Aboslutely! You can submit a request for maintenance with this link: <a href = 'http://localhost:49799/maintenancerequests/create'  target= '_blank'>click here to check it out!</a></span>";
    }
    else if (userInput.includes("maintenance") && (userInput.includes("status") || userInput.includes("update"))) {
        document.getElementById("chadResponse").innerHTML = "<span>The current status of your maintenance request can be found here: <a href = 'http://localhost:49799/Residents/PendingRequests'  target= '_blank' >click here to check it out!</a></span>";;
    }
    else
    {
